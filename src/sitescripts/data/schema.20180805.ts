          ...
          "items": {
            "anyOf": [
              ...
              },
              {
                "type": "object",
                "$ref":
                  "#/definitions/SPListSubactions/setSPFieldCustomFormatter"
              },
              {
                "type": "object",
                "$ref":
                  "#/definitions/SPListSubactions/associateFieldCustomizer"
              },
              {
                "type": "object",
                "$ref":
                  "#/definitions/SPListSubactions/associateListViewCommandSet"
              }
            ]
          }
        }
